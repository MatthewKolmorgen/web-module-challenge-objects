...
function createMenuItem(name, price, category){
  // what will be passed into the array
  menuItem = {name, price, category}
  // returning so i can access outside of function
  return menuItem
}

/* Task 1b: use your function to create 3 more menu items. You may add any items to the menu that you'd like */
console.log(createMenuItem('Taco', 5, 'Anytime'));
console.log(createMenuItem('PB&J', 4, 'Lunch'));
console.log(createMenuItem('Pastalaya', 13, 'Dinner'));
